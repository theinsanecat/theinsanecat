...
export const UFOCatSpaceship = ({ isHovered, isActive, className = '', style = {} }) => {
  ...
  return (
    <motion.div 
      ...
      style={{
        top: "-60px", // Suspended perfectly inside the core pink volumetric beam
    ...
    >
      <div className="relative w-full h-full" style={{ overflow: "visible" }}>
        ...
        >
          ...
          {/* Cockpit rim — restored to pink as requested */}
          <ellipse cx="100" cy="106" rx="46" ry="12" fill="#db2777" stroke="#9d174d" strokeWidth="1.8" />

          {/* Dome glass fill — pure half-dome, no bottom arc (that arc was the pink line source) */}
          <path 
            d="M 54,106 C 54,42 146,42 146,106 Z" 
            fill="url(#dome-glass)" 
          />

          {/* Glass dome attachment bottom border (rear side, behind cat) */}
          ...
          <g id="cat-pilot" transform="translate(100, 106) scale(0.52) translate(-100, -94)">
            ...
            {/* Cat Head — shifted up slightly to expose mouth/smile, colored black */}
            <ellipse cx="100" cy="65" rx="27" ry="23" fill="#18181b" />

            {/* LEFT EYE — small glowy blue dot */}
            <circle cx="87" cy="60" r="2.2" fill="#38bdf8" />

            {/* RIGHT EYE — small glowy blue dot */}
            <circle cx="113" cy="60" r="2.2" fill="#38bdf8" />

            {/* Nose — hot pink */}
            <ellipse cx="100" cy="68" rx="3" ry="2" fill="#db2777" />

            {/* Body — turned 180 degrees and shortened at bottom, colored black */}
          ...
          {/* ─────────────────────────────────────────
              DOME FRONT UPPER ARC — drawn AFTER cat
              → arc appears IN FRONT of cat's head,
                giving proper 3D glass dome depth
              ───────────────────────────────────────── */}
          <path 
          ...
          {/* Dome bottom border (outer front side, in front of cat) */}
          <path 
...
// Preventing browser repaints or reference dropouts during state updates.
...
GlobalSVGDefs.displayName = 'GlobalSVGDefs';
